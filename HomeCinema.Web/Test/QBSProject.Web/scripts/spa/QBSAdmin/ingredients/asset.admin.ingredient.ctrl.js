(function (app) {
    ...
    function ingredientCtrl($scope, $modal, $rootScope, apiService, IngredientService, Notification, blockingservice, $location, $routeParams) {
        ...
        $scope.topbarurl = "/scripts/spa/QBSAdmin/ingredients/template/topbar.html";
        $scope.sidebarurl = "/scripts/spa/QBSAdmin/ingredients/template/sidebar.html";
        $scope.ingredient = {};
        ...
        function openDeleteDialog(ingredient) {
            ...
            $modal.open({
                templateUrl: 'scripts/spa/QBSAdmin/ingredients/deleteIngredientModal.html',
