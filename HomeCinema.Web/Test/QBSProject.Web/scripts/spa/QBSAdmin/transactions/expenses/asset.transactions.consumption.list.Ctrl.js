(function (app) {
    "use strict";
    app.controller("asset.transactions.consumption.list.Ctrl", consumptionListCtrl);
    consumptionListCtrl.$inject = ['$scope', '$rootScope', 'membershipService', '$modalInstance', '$timeout', 'apiService', 'Notification', '$routeParams', '$location', 'constants'];

    function consumptionListCtrl($scope, $rootScope, membershipService, $modalInstance, $timeout, apiService, Notification, $routeParams, $location, constants) {
        ...
        function searchPOList(page) {
            ...
            var config = {
                params: {
                    ...
                    docType:$rootScope.docType
                }
            };
            apiService.get('/api/expenses/search/', config,
            listCompleted,
            listFailure);
        }
