(function (app) {
    "use strict";
    app.controller("asset.transactions.sales.list.Ctrl", salesListCtrl);
    salesListCtrl.$inject = ['$scope', '$rootScope', 'membershipService', '$modalInstance', '$timeout', 'apiService', 'Notification', '$routeParams', '$location', 'constants'];

    function salesListCtrl($scope, $rootScope, membershipService, $modalInstance, $timeout, apiService, Notification, $routeParams, $location, constants) {

        $rootScope.searchPurchaseList = searchPurchaseList;
        $scope.cancelEdit = cancelEdit;
        $scope.busyLoad = true;
        $scope.clearSearch = clearSearch;
        $scope.selectSales = selectSales;

        function selectSales(id, AssetId) {
            $rootScope.fillSalesData(id, AssetId);
        ...
        function searchPurchaseList(page) {
            ...
            apiService.get('/api/sales/search/', config,
            listCompleted,
            listFailure);
        }
