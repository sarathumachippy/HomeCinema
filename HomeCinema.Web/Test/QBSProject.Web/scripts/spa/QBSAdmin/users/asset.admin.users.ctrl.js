(function (app) {
    ...
    function usersCtrl($rootScope, $scope, $modal, apiService, UsersService, Notification, blockingservice, $location, $routeParams, constants) {
        ...
        function openEditDialog(user) {
            ...
            $modal.open({
                templateUrl: 'scripts/spa/QBSAdmin/users/editUserModal.html',
        ...
        function openDeleteDialog(user) {
            $scope.EditedUser = user;
            $modal.open({
                templateUrl: 'scripts/spa/QBSAdmin/users/deleteUserModal.html',
                controller: 'asset.admin.users.edit.ctrl',
                scope: $scope,
                backdrop: 'static',
                keyboard: false
        ...
        function openChgPwdDialog(user) {
            $scope.EditedUser = user;
            $modal.open({
                templateUrl: 'scripts/spa/QBSAdmin/users/changeUserPwdModal.html',
                controller: 'asset.admin.users.edit.ctrl',
                scope: $scope,
                backdrop: 'static',
                keyboard: false
